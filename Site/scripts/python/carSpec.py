        ...
        content = """<!DOCTYPE html>
                ...
                <div class="caraContainer">
                  <div class="slideshow-container">
                    ...
                    <div class="mySlides fade">
                      <img src="../../imgs/cars/car"""+line[0]+"""-1.png" alt="view 1">
                    </div>

                    <div class="mySlides fade">
                      <img src="../../imgs/cars/car"""+line[0]+"""-2.png" alt="view 2">
                    </div>

                    <div class="mySlides fade">
                      <img src="../../imgs/cars/car"""+line[0]+"""-3.png" alt="view 3">
                    </div>

                    <div class="mySlides fade">
                      <img src="../../imgs/cars/car"""+line[0]+"""-4.png" alt="view 4">
                    </div>

                    <div class="mySlides fade">
                      <img src="../../imgs/cars/car"""+line[0]+"""-5.png" alt="view 5">
                    </div>

                    <!-- Next and previous buttons -->
                    <div class="slideNavigation">
                      <button class="scale" type="button" name="button" onclick="plusSlides(-1)">&#10094;</button>
                      <a onclick="currentSlide(1)"><img src="../../imgs/cars/car"""+line[0]+"""-1.png" alt="view 1 button"></a>
                      <a onclick="currentSlide(2)"><img src="../../imgs/cars/car"""+line[0]+"""-2.png" alt="view 2 button"></a>
                      <a onclick="currentSlide(3)"><img src="../../imgs/cars/car"""+line[0]+"""-3.png" alt="view 3 button"></a>
                      <a onclick="currentSlide(4)"><img src="../../imgs/cars/car"""+line[0]+"""-4.png" alt="view 4 button"></a>
                      <a onclick="currentSlide(5)"><img src="../../imgs/cars/car"""+line[0]+"""-5.png" alt="view 5 button"></a>
                      <button class="scale" type="button" name="button" onclick="plusSlides(1)">&#10095;</button>
                    </div>
                  </div>
                </div>
                ...
                <div class="gridContainer">
                  ...
                  <div class="contact">
                    ...
                    <button id = "submit" class = "scale" type="button" name="button" onclick="submit()"> <h1>Submit</h1> </button>
                    <div class="reveal">
